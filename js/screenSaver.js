...
const screenSaverTimeout = (origin) => {
  if(origin != undefined && origin != "undefined" && origin != null){
    localStorage["destination"] = origin;
  }
  timeout = setTimeout(() => {
...
const exitScreenSaver = () => {
  ...
  if(destination == "undefined" || destination == undefined || destination == null){ 
    destination = "home.php";
  }
  document.onkeyup = () =>{window.location.href = destination;}
  document.onclick = () =>{window.location.href = destination;}
}

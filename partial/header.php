		...
		<body>
			...
			<?php
				...
				elseif ($page == "deckMaster"){
					?><div class="typing" onclick="window.location.href='home.php';">Deck_Master________________________________________________________________________________________________________________________________________________________________</div><?php
				}
				elseif ($page == "booting"){
					?><?php
				}
				elseif ($page == "guide"){
					?><div class="typing" onclick="window.location.href='home.php';" >Guide_Stratégique________________________________________________________________________________________________________________________________________________________________</div><?php
				}
				else {

	...
	<html lang="fr">
		...
		<body>
			...
			<?php
				...
				elseif ($page == "guide"){
					?><div class="typing">Guide_Stratégique________________________________________________________________________________________________________________________________________________________________</div><?php
				}
				else {
